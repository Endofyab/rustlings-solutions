...
//created this function and added [derive(Debug)]
fn add_to_table( scores: &mut HashMap<String, Team>,
    team_1_name: String,
    team_1_score: u8,
    team_2_score: u8,
) {
...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        //using above funtion 
        //add_to_table(&mut scores, team_1_name, team_1_score, team_2_score);
        //add_to_table(&mut scores, team_2_name, team_2_score, team_1_score);
        
        // or

        //using wacky closures 
        scores
            .entry(team_1_name)
            .and_modify(|t| {
